...
def create_finetune_model():
    """
    Crea un modelo con backbone parcialmente entrenable para fine tuning.
    """
    backbone = load_backbone()
    
    # Descongelamos las últimas capas del backbone EfficientNet
